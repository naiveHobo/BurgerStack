...
Brings up the small_house world + RGB-D burger + SLAM + Nav2 + frontier explorer (all from
...
Brings up the small_house world + AMCL (against the saved occupancy map) + Nav2, and adds:
